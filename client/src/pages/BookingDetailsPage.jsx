...
const BookingDetailsPage = () => {
  ...
  return (
    <div className="my-8">
      ...
      <h1 className="text-xl font-bold mb-2 font-openSans">
        {booking.place.title}
      </h1>
      ...
      <div className="bg-primary p-6 my-4 rounded-2xl">
        <h2 className="text-lg font-bold font-openSans">Booking information</h2>
        ...
        <p className="mt-2 flex gap-2">
          ...
          <b className="font-openSans">Dates:</b>
        ...
        <p className="mt-2 flex gap-2">
          ...
          <b className="font-openSans">Price:</b> ${booking.price.toFixed(2)}{" "}
          for{" "}
        ...
        <p className="mt-2 flex gap-2">
          ...
          <b className="font-openSans">Booked by:</b> {booking.name}
          <b className="ml-6 font-openSans">Number of guests:</b>{" "}
